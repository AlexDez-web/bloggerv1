...
if (
    ...
    $req_insert = "INSERT INTO articles (id_user, titre, description, description_html, couverture, tag) VALUES ('$id_user' ,'$titre', '$description_brut', '$description_html', '$url', '$keyword')";
